...
public class NativePromote extends FrameLayout {
    ...
    private void buildNative(final int index) {
        ...
        boolean isDarkMode = ((MyAppsNativesItem) this.adList.get(index)).isIsDark();
        ...
        if (isDarkMode) {
            this.nativeBody.setBackgroundColor(getResources().getColor(R.color.color_rating_dark));
            this.name.setTextColor(getResources().getColor(R.color.white));
            this.nativeDescription.setTextColor(getResources().getColor(R.color.white));

        } else {
            this.nativeBody.setBackgroundColor(getResources().getColor(R.color.lightcColor));
            this.name.setTextColor(getResources().getColor(R.color.darkColor));
            this.nativeDescription.setTextColor(getResources().getColor(R.color.darkColor));

        }
        this.adColor.setBackgroundColor(buttonTintColor);
        this.adColor.setTextColor(buttonTextColor);
        if (this.onNativeListener != null) {
