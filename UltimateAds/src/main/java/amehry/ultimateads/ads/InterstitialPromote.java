...
public class InterstitialPromote extends Dialog {
    ...
    private void updateInterstitial(final int index) {
        ...
        boolean isDarkMode = ((MyAppsIntersItem) this.adList.get(index)).isIsDark();
        int buttonTintColor = Color.parseColor(((MyAppsIntersItem) this.adList.get(index)).getButtonTintColor());
        int buttonTextColor = Color.parseColor(((MyAppsIntersItem) this.adList.get(index)).getButtonTextColor());
        if (isDarkMode) {
            int background = Color.parseColor("#1B1B16");
            int titles = Color.parseColor("#ffffff");
            int closebtnbc = Color.parseColor("#ffffff");
            int closebtntxt = Color.parseColor("#1B1B16");

            this.close.setBackgroundTintList(ColorStateList.valueOf(closebtnbc));
            this.closeText.setTextColor(closebtntxt);
            this.name.setTextColor(titles);
            this.description.setTextColor(titles);
            ...
            int background = Color.parseColor("#F4F4F4");
            int titles = Color.parseColor("#000000");
            int closebtnbc = Color.parseColor("#000000");
            int closebtntxt = Color.parseColor("#F4F4F4");
            this.close.setBackgroundTintList(ColorStateList.valueOf(closebtnbc));
            this.closeText.setTextColor(closebtntxt);
            this.name.setTextColor(titles);
            this.description.setTextColor(titles);
        ...
        this.springDotsIndicator.setDotIndicatorColor(buttonTintColor);
        this.springDotsIndicator.setStrokeDotsIndicatorColor(buttonTintColor);

        this.ad.setBackgroundColor(buttonTintColor);
        this.ad.setTextColor(buttonTextColor);

        this.install.setBackgroundTintList(ColorStateList.valueOf(buttonTintColor));
        this.installTitle.setTextColor(buttonTextColor);
